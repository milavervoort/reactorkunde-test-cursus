...
\begin{itemize}
\item \textbf{Batchreactoren} \ref{Kinetische metingen in een batch reactor}, voornamelijk voor de studie van homogene reacties;
...
Soms wordt de concentratie gekoppeld aan andere meetbare eigenschappen, zoals: thermische conductiviteit, viscositeit, spectrometrie of de totaaldruk.
...
t=t & N_{A0}-ax & N_{B0}-bx & N_{R0}+rx & N_{S0}+x & N_{I0}
\end{array}
\]
...
\Delta n = (r + s - a - b)
\]
de netto verandering in het aantal mol.
De concentratie van component $A$ is
\[
C_A = \frac{N_A}{V} = \frac{N_{A0} - x}{V}.
\]
...
\begin{itemize}
    \item Integrale analysemethode; zie \ref{xim:Integrale analysemethode}
    \item Differentiële analysemethode; zie \ref{xim:Differentiële analysemethode}
