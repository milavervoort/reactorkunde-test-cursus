...
V
ergelijk de voorspelling met de exacte waarde van $y=x^2+1.$ Welke conclusie is dan het meest correct?
...
Een neuraal netwerk leert de relatie uit de beschikbare trainingsdata. Het doel van de training is daarom niet noodzakelijk om voor elk punt exact de
juiste waarde te verkrijgen, maar om een functie te vinden die de gegevens zo goed mogelijk benadert.
\end{feedback}
