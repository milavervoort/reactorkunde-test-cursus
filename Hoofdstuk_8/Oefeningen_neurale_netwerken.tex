...
We willen nu een neuraal netwerk gebruiken om dit verband data-driven te leren. Denk hierbij aan de huidige toestand van het reactiesysteem:
de concentratievector
\[
\mathbf C=
\begin{pmatrix}
C_A\\
...
Als we deze toestand aan het netwerk geven, willen we dat het netwerk voorspelt hoe het systeem op dat moment verder verandert.

Welke combinatie van input en output past hier het best bij?
