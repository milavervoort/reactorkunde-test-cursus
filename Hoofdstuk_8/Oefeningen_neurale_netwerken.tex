...
% Hidden layer 1: 16 neuronen
\foreach \i in {1,...,16}
    \node[neuron] (h1\i) at (2,{4.0-\i*0.5}) {};

% Hidden layer 2: 16 neuronen
\foreach \i in {1,...,16}
    \node[neuron] (h2\i) at (4,{4.0-\i*0.5}) {};

% Output
\node[neuron] (y1) at (6,0.8) {};
\node[neuron] (y2) at (6,0) {};
\node[neuron] (y3) at (6,-0.8) {};
...
\begin{multipleChoice}
\choice{Het netwerk heeft de experimentele gegevens gebruikt om een klassieke kinetische vergelijking met een vaste vorm te bepalen.}

\choice[correct]{Het netwerk heeft een relatie geleerd die de dynamica van het reactiesysteem over het onderzochte bereik goed kan reproduceren.}
