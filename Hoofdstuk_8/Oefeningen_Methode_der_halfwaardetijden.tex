...
\begin{question} \textbf{Interpreteren van de plot}
 ...
 We kunnen nu een plot maken met behulp van de experimentele data om de orde van de reactie te bepalen. Gebruik de python code in volgende Google Colab-file om de oefening verder op te lossen. Vul de lege regels in waar nodig om de berkeningen uit te voeren.\\ 
    \begin{center}
\href{https://colab.research.google.com/drive/1J_b7UtZWXgh0nGZow6fvx2xy9mOAorfS?usp=sharing}{\Large Open de Google Colab notebook}
    \end{center}
...
\begin{feedback} \text{  }
    ...
    \[k_1 = \frac{\ln(2)}{1.0} \text{ s}^{-1} = 0.69 s^{-1}\]
