...
In de volgende oefening gebruiken we een neuraal netwerk om de dynamica van een batchreactor te leren. De invoer van het netwerk bestaat hierbij uit de concentraties van de verschillende componenten:
...
Het netwerk geeft vervolgens een schatting van de verandering van deze concentraties:
...
Het netwerk leert dus niet rechtstreeks een klassieke kinetische vergelijking zoals

\[
r_A=kC_A^n.
\]

In plaats daarvan leert het een algemene relatie tussen de toestand van het reactiesysteem en de verandering ervan:

\[
\frac{dC}{dt}=f_\theta(C).
\]

Deze relatie wordt vervolgens gecombineerd met de bekende structuur van een differentiaalvergelijking om de concentratieprofielen van de reactor te simuleren.
