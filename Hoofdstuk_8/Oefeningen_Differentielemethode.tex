...
Beschouw het eerste tijdsinterval tussen $t=0$ min en $t=5$ min:
\begin{enumerate}
...
Gebruik de Google Colab-file om de afgeleide te bepalen voor alle opgemeten tijdsintverallen.
...
Om de plot te kunnen maken, moeten de waarde voor x en y nog bepaald worden met behulp van de gelineariseerde uitdrukking. 

Vul de Google-Colab file verder aan en duid de correcte tabel aan met behulp van de bekomen resultaten.
...
Met behulp van de lineaire fit kunnen $k$ en $n$ bepaald worden:
\[n = \answer{1.04}\]
\[k = \answer{0.073}\]
\begin{feedback} .
\newline
