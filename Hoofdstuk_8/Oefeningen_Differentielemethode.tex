...
Gebruik de Python-code in de volgende Google Colab-file om de berekeningen uit te
voeren en de ontbrekende regels aan te vullen.
...
Dezelfde berekening wordt vervolgens automatisch uitgevoerd voor alle
