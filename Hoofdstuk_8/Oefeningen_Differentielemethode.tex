...
Gebruik de Google Colab-file om de afgeleide te bepalen op alle intermediare waarden.

Beschouw het \textbf{eerste tijdsinterval} tussen $t=0$ min en $t=5$ min:
\begin{enumerate}
...
eMet behulp van de lineaire fit kunnen $k$ en $n$ bepaald worden:
\[n = \answer{1.04}\]
\[k = \answer{0.073}\]
\begin{feedback} .
\newline
