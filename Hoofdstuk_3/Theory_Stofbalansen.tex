...
In de volgende grafiek is te zien hoe de concentratie van reagens A afneemt in functie van de tijd voor verschillende reactie-ordes, telkens met dezelfde beginconcentratie en dezelfde snelheidsconstante $k$.
...
% n = 3
\addplot[green!60!black, thick] {1/sqrt(1 + 2*x)};
