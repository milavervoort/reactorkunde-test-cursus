...
\begin{axis}[
    xlabel={$X_A$},
    ylabel={$-1/r_A$},
    domain=0.01:0.8, % Avoid division by zero at x = 1
    samples=100,
    axis lines=left,
    width=10cm,
    height=7cm,
...
\addplot[
    domain=0.01:0.6, % Avoid division by zero at x = 1
    fill=blue!20
] {1/(1-x)} \closedcycle;
...
\begin{axis}[
    xlabel={$C_A$},
    ylabel={$-1/r_A$},
    domain=0.2:1, % Avoid division by zero at x = 0
    samples=100,
    axis lines=left,
    width=10cm,
    height=7cm,
...
\addplot[
    domain=0.4:1, % Avoid division by zero at x = 0
    fill=red!20
] {1/x} \closedcycle;

\node at (axis cs:0.7,2) {Oppervlakte = $t$};
