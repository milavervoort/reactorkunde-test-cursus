...
\Title{Theorie hoofdstuk 3: Ontwerp van homogene reactoren onder isotherme werkingsvoorwaarden}
...
In het geval van een monotoom stijgende kinetica geldt:
...
\item $R q$ = Recycledebiet
\item $q (R+1)$ = Totaal debiet door de reactor 
...
\[
\text{Accumulation} = \text{In} - \text{Uit} + \text{Reaactie}
\]
\[
